...
import { assignWorkoutDays } from "@/domain/plan-generation/assignWorkoutDays";
import { getMileageProgression } from "@/domain/plan-generation/utils/getMileageProgression";
import { User } from "@/domain/types";
import { getDayToDate, getWeekStartDate } from "@/domain/plan-generation/utils/getWeekStartDate";
import { getTrainingPacesFromWorkoutSegments } from "@/domain/plan-generation/utils/getTrainingPacesFromWorkoutSegments";
...
import { getTrainingPaces } from "@/domain/plan-generation/utils/getTrainingPaces";
